...
-- Covers: site settings toggles, visit tracking, category
-- toggles, customer blocking, admin invites, signup codes.
-- ============================================================

-- 1. Site settings + visit tracking
